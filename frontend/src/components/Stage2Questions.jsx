...
export default function Stage2Questions({ sessionId, onComplete, navigate: customNavigate }) {
    ...
    return (
      <div className="max-w-3xl mx-auto px-4 py-12">
        <div className="text-center" style={{ color: '#e5e7eb' }}>
          ...
          <p>Loading questions for {domain || 'your domain'}...</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="max-w-3xl mx-auto px-4 py-12">
        <div style={{
          ...
          <h2 className="text-2xl font-bold mb-2" style={{ color: '#e5e7eb' }}>Career Predicted!</h2>
          <p className="text-xl font-semibold mb-4" style={{ color: '#1e9ff5' }}>
            {careerResult.predicted_career?.replace('_', ' ').toUpperCase() || 'Processing...'}
          </p>
          <p className="mb-2" style={{ color: '#9ca3af' }}>Confidence: {careerResult.confidence ? (careerResult.confidence * 100).toFixed(1) : 'N/A'}%</p>
          <p className="text-sm" style={{ color: '#9ca3af' }}>Generating your report...</p>
        </div>
      </div>
    )
  }
      ...
      <div style={{
        ...
        <div className="mb-4">
          <div style={{
            ...
            {domain?.replace('_', ' ').toUpperCase() || 'DOMAIN'} Domain
          </div>
        </div>
